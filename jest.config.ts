 ...
 */
/*Complete setup with typescript and jest 
https://dev-mind.fr/blog/2019/start_typescript_project_and_test_with_jest.html
with babel and compare to other framework: 
...
/*Récupération des infos du tsconfig
https://medium.com/@fmoessle/typescript-paths-with-ts-node-ts-node-dev-and-jest-671deacf6428
https://kulshekhar.github.io/ts-jest/docs/getting-started/paths-mapping/
*/
//require via json5 à cause des commentaires dans le tsconfig.json (pb de parse sinon )
