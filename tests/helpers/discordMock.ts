...
export class DiscordMock{
    ...
    // Autre solution : https://dev.to/heymarkkop/how-to-implement-test-and-mock-discordjs-v13-slash-commands-with-typescript-22lc?signin=true  
    // Création constructeur private avec prototype https://stackoverflow.com/questions/60530831/mock-typescript-class-with-private-constructor-using-jest
